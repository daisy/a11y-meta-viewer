...
The localized display statement files used in this application were obtained from:
...
The files have been renamed and modified from JSON objects to JavaScript variables but are otherwise unchanged. 
